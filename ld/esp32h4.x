...
MEMORY {
    /* SRAM starts at 0x40810000 (SOC_IRAM_LOW). Offset IRAM by 16 bytes so the
       probe-rs algorithm header (8 bytes before load_address) stays inside SRAM.
       Stay below the 2nd-stage bootloader loader segment (SRAM_SEG_END 0x4084f350)
       and ROM-reserved data near 0x4085fff4. */
    IRAM   : ORIGIN = 0x40810010, LENGTH = 0xFFF0
